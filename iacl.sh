...
useradd maria -m -s /bin/bash -p $ (openssl passwd - crypt Senha 123) -G GRP-ADM
useradd joao -m -s /bin/bash -p $ (openssl passwd - crypt Senha 123) -G GRP_ADM

useradd debora -m -s /bin/bash -p $ (openssl passwd - cript Senha 123) -G GRP_VEN
useradd sebartiana -m -s /bin/bash -p $ (openssl passwd - crypt Senha 123) -G GRP_VEN
